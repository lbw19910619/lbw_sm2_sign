...
@implementation MF_Base64CodecSM2
...
-(NSString *)base64String
{
    ...
    return [MF_Base64CodecSM2 base64StringFromData:utf8encoding];
}
-(NSString *)base64UrlEncodedString
{
    return [MF_Base64CodecSM2 base64UrlEncodedStringFromBase64String:[self base64String]];
}
+(NSString *)stringFromBase64String:(NSString *)base64String
{
    NSData *utf8encoding = [MF_Base64CodecSM2 dataFromBase64String:base64String];
...
{
    return [self stringFromBase64String:[MF_Base64CodecSM2 base64StringFromBase64UrlEncodedString:base64UrlEncodedString]];
}
@end
...
{
    return [MF_Base64CodecSM2 dataFromBase64String:base64String];
}
+(NSData *)dataWithBase64UrlEncodedString:(NSString *)base64UrlEncodedString
{
    return [self dataWithBase64String:[MF_Base64CodecSM2 base64StringFromBase64UrlEncodedString:base64UrlEncodedString]];
}
-(NSString *)base64String
{
    return [MF_Base64CodecSM2 base64StringFromData:self];
}
-(NSString *)base64UrlEncodedString
{
    return [MF_Base64CodecSM2 base64UrlEncodedStringFromBase64String:[self base64String]];
